...
public final class CustomerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest,
      net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse> getGetAllCustomersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAllCustomers",
      requestType = net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest.class,
      responseType = net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest,
      net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse> getGetAllCustomersMethod() {
    io.grpc.MethodDescriptor<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest, net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse> getGetAllCustomersMethod;
      ...
      synchronized (CustomerServiceGrpc.class) {
        if ((getGetAllCustomersMethod = CustomerServiceGrpc.getGetAllCustomersMethod) == null) {
          CustomerServiceGrpc.getGetAllCustomersMethod = getGetAllCustomersMethod = 
              io.grpc.MethodDescriptor.<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest, net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CustomerService", "GetAllCustomers"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdRequest,
      net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdResponse> getGetCustomerByIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCustomerById",
      requestType = net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdRequest.class,
      responseType = net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdRequest,
      net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdResponse> getGetCustomerByIdMethod() {
    io.grpc.MethodDescriptor<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdRequest, net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdResponse> getGetCustomerByIdMethod;
      ...
      synchronized (CustomerServiceGrpc.class) {
        if ((getGetCustomerByIdMethod = CustomerServiceGrpc.getGetCustomerByIdMethod) == null) {
          CustomerServiceGrpc.getGetCustomerByIdMethod = getGetCustomerByIdMethod = 
              io.grpc.MethodDescriptor.<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdRequest, net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CustomerService", "GetCustomerById"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdResponse.getDefaultInstance()))
  ...
  public static abstract class CustomerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAllCustomers(net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest request,
        io.grpc.stub.StreamObserver<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetAllCustomersMethod(), responseObserver);
    }

    /**
     */
    public void getCustomerById(net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdRequest request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest,
                net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse>(
  ...
  public static final class CustomerServiceBlockingStub extends io.grpc.stub.AbstractStub<CustomerServiceBlockingStub> {
    ...
    /**
     */
    public net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse getAllCustomers(net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest request) {
  ...
  public static final class CustomerServiceFutureStub extends io.grpc.stub.AbstractStub<CustomerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse> getAllCustomers(
        net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdResponse> getCustomerById(
        net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersByIdRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ALL_CUSTOMERS:
          serviceImpl.getAllCustomers((net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetAllCustomersRequest) request,
              (io.grpc.stub.StreamObserver<net.fred.customerdataservice.stub.CustomerServiceOuterClass.GetCustomersResponse>) responseObserver);
          break;
  ...
  private static abstract class CustomerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return net.fred.customerdataservice.stub.CustomerServiceOuterClass.getDescriptor();
    }
